...
export default function AgentLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="reports"
        options={{ title: 'Reports', href: show('CRM-0099') ? undefined : null, tabBarIcon: () => null }}
      />
      <Tabs.Screen
        name="surveys"
        options={{ title: 'Surveys', href: show('CRM-0097') ? undefined : null, tabBarIcon: () => null }}
      />
      <Tabs.Screen
        name="routes"
        options={{ title: 'Routes', href: show('CRM-0098') ? undefined : null, tabBarIcon: () => null }}
      />
      <Tabs.Screen
        name="inventory"
        options={{ title: 'Inventory', href: show('CRM-0093') ? undefined : null, tabBarIcon: () => null }}
      />
      <Tabs.Screen
        name="support-ticket"
        options={{ title: 'Chat', href: show('CRM-0110', true) ? undefined : null, tabBarIcon: () => null }}
      />
      <Tabs.Screen
        name="profile"
        options={{ title: 'Profile', href: show('CRM-0090', true) ? undefined : null, tabBarIcon: () => null }}
      />
