/**
 * Profile screen — Account card with logout outside the action-button row.
 *
 * FALLBACK SNAPSHOT — reference-only; not imported by active Profile UI.
 * Active implementation: profile.tsx
 * Filename is underscore-prefixed so Expo Router ignores it as a route.
 */
