...
export const MOBILE_COMPONENTS: MobileComponent[] = [
  ...
  { code: 'CRM-0097', name: 'Surveys', path: 'surveys', group: 'agent-page', description: 'Run assigned surveys and submit responses from the field.' },
  ...
  { code: 'CRM-0098A', name: 'Set Assigned Location', path: 'routes/set-location', group: 'agent-action', description: 'Pick a store and set it as the agent\'s assigned location.' },
  { code: 'CRM-0098L', name: 'Add Store', path: 'routes/add-store', group: 'agent-action', description: 'Add a new store at the agent\'s current GPS location.' },
  ...
  { code: 'CRM-0127', name: 'Teams', path: 'teams', group: 'supervisor-page', description: 'Create teams, assign members, and manage team leads from Users.' },
